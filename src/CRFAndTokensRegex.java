...
public class CRFAndTokensRegex {

	public static void main(String[] args) throws Exception {

		File keyParaDir = new File("./data/key_paragraphs_split/");

		// choose the CRF model and rule set to use and comment the other one out
...
//		String rules = "./res/rules/old.rules.txt";
		...
		properties.setProperty("customAnnotatorClass.ner", 
				"edu.stanford.nlp.ie.crf.CRFClassifier");
		properties.setProperty("ner.model", serializedClassifier);
