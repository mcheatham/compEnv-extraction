...
public class WikipediaAndTokensRegex {

	public static void main(String[] args) throws Exception {

		File keyParaDir = new File("./data/key_paragraphs_split/");

		String rules = "./res/rules/old.rules.txt";
//		String rules = "./res/rules/current.rules.txt";
		...
		properties.setProperty("annotators", "tokenize,ssplit,pos,lemma,wikipedia,tokensregexdemo");
		properties.setProperty("customAnnotatorClass.wikipedia", "WikipediaAnnotator");
		properties.setProperty("wikipedia.tagFile", "./res/tags.txt");
		properties.setProperty("wikipedia.synonymFile", "./res/synonyms.txt");
		properties.setProperty("wikipedia.cacheFile", "./res/caches/wikiCache.txt");
